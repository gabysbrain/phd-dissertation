...
\ttwnote{link to 2D views of shapes}
...
1D slices cannot do everything. There are datasets and tasks where we need to
examine the relationship between dimensions, thus 2D slices are the minimum
number necessary to examine these relationships. \ttwnote{expand}
