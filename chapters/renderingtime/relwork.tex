...
Often, the data points represent samples of a continuous function. Hence, it
...
%In fact, such areas as applied statistics, machine learning, and numerical 
%mathematics pursue this path. 
...
%Kernel reconstruction can also be used to estimate the
%\emph{density} of points in the parameter space. This is known as kernel
%density estimation (KDE)~\cite{Parzen:1962,Rosenblatt:1956}.
%We can map
%KDE into standard kernel regression by assuming that $f(x_i) = 1$ for all
%$x_i$.
