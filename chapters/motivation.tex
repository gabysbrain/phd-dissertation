...
increasing. \ttwnote{this is why shapes are nice to reason about}
...
\ttwnote{how we visualizae multi-D continuous stuff}

\ttwnote{shorten this and move details to specific section} 
\ttwnote{can put something here like both proj and topology distort what we're 
         looking for and the distortion isn't clear} 
While not as extensively developed \ttwnote{(or popular)}, there is previous
...
\ttwnote{put in chart from Jurgen's presentation (projection vs dim
reduction)?} Projection methods attempt to distort the multi-dimensional object
...
\ttwnote{continuous vs discrete section}
