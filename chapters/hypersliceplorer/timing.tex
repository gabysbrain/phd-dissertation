...
\begin{table*}[!htb]
  ...
  \caption{%
    ...
    datasets. We ran the algorithm, setting the number of slices to $1,000$.
    We record the number of simplices created by the quickhull
...
In order to test the running time of our algorithm we ran a number of
