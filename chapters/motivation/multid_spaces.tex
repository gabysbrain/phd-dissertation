...
\ttwnote{talk about why multi-D discrete data is so popular}
...
\ttwnote{para on why this isn't enough, what is missing, and what I contribute}
...
of the dataset can give insight into the overall shape\ttwnote{use a different, more specific work than shape} of the object. For
